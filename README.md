[INTROH.PAS] Combined a bunch of effects on lowres EGA64. Mainly intended for real 286 and real EGA adapter, but emulation seems possible with the latest DOSBox-X and small tweaks to the code. Now also playes a nice AdLib tune.
